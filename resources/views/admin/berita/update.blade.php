					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
                                    <button class="my-2 btn btn-secondary" type="submit"><a href="{{ url('/admin/berita')}}" class="btn-secondary">Kembali</a></button>
                                    <form action='{{ url('admin/berita/'.$data->id) }}' method='post' enctype="multipart/form-data">
                                        ...
                                        <div class="my-3 p-3 bg-body">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="isi" id="isi" rows="3" >{{ $data->isi }}"</textarea>
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
